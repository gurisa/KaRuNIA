  <footer class="page-footer grey darken-4">
    <div class="container">
      <div class="row">
        ...
        <div class="col s12 m3">
          ...
          <ul>
            <li><a class="grey-text text-lighten-2" href="#kelompok">Kelompok</a></li>
            <li><a class="grey-text text-lighten-2" href="#pengguna">Data Pengguna</a></li>
          </ul>
        </div>
        <div class="col s12 m3">
    ...
    <div class="footer-copyright grey darken-3">
      <div class="container center-align">
        Copyright &copy; 2017 Gurisa.Com all right reserved.
      </div>
    </div>
  </footer>
